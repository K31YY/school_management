...
class _AddTeacherState extends State<AddTeacher> {
  ...
  Future<void> _handleSave() async {
    ...
    try {
      ...
      // Send the raw integer for the database
      request.fields['UserID'] = _currentUserId?.toString() ?? "";
      // Send the formatted string if your API expects the "UTB001" format
      request.fields['RollNo'] = _rollNoCtrl.text;
